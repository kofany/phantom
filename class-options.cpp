...
chanset::chanset()
{
	...
	registerObject(IDIOTS = entInt("idiots", 0, 6, 2));
	registerObject(OP_LOCKDOWN = entBool("op-lockdown", 0));
...
CONFIG::CONFIG()
{
	...
	/* optional options :) */
	registerObject(realname = entString("realname", 1, 255, "Phantom"));
	...
	registerObject(botnetword = entWord("botnetword", 1, 255, "###\001[PH]\001Phantom\001###"));
	...
	registerObject(partyline_servername = entWord("partyline-servername", 1, 255, "Phantom"));
